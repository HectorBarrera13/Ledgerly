...
import toast.appback.src.debts.application.usecase.implementation.ReportDebtPaymentUseCase;
...
public class ReportDebtPaymentTest {

    private DebtRepository debtRepository;
    private UserRepository userRepository;
    private DomainEventBus domainEventBus;

    private ReportDebtPaymentUseCase useCase;
    ...
    void setup() {
        ...
        useCase = new ReportDebtPaymentUseCase(
                debtRepository,
                userRepository,
                domainEventBus
        );
        ...
        debt = DebtBetweenUsers.load(
                DEBT_ID, ctx, money, DEBTOR_ID, CREDITOR_ID, Status.ACCEPTED
        );
    ...
    @Test
    void execute_ShouldReportPayment_Save_AndPublishEvents() {
        ...
        assertEquals(Status.PAYMENT_CONFIRMATION_PENDING.toString(), view.status());
